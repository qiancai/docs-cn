...
aliases: ['zh/tidb/dev/release-5.0.2/', 'zh/tidb/v5.0/release-5.0.2']
---
...
+ TiDB
    ...
    - 修复了当 sql_mode 包含 `ANSI_QUOTES` 时，数值字面值无法被识别的问题 [#24429](https://github.com/pingcap/tidb/issues/24429)

...
aliases: ['zh/tidb/dev/release-6.2.0/', 'zh/tidb/v6.2/release-6.2.0']
---
...
- TiDB Dashboard 支持[可视化执行计划](https://docs-archive.pingcap.com/zh/tidb/v6.2/dashboard-slow-query#图形化执行计划介绍)，查询计划展示更直观。
...
* TiDB Dashboard 支持可视化执行计划
    ...
    [用户文档](https://docs-archive.pingcap.com/zh/tidb/v6.2/dashboard-slow-query#图形化执行计划介绍) [#1224](https://github.com/pingcap/tidb-dashboard/issues/1224) @[time-and-fate](https://github.com/time-and-fate)

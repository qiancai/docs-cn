...
aliases: ['zh/tidb/dev/release-7.1.2/', 'zh/tidb/v7.1/release-7.1.2']
---
...
+ Tools
    ...
    + TiCDC
        ...
        - 修复 TiCDC 在同步数据到 Kafka 时可能卡住的问题 [#9855](https://github.com/pingcap/tiflow/issues/9855) @[hicqu](https://github.com/hicqu)

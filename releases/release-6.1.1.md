...
aliases: ['zh/tidb/dev/release-6.1.1/', 'zh/tidb/v6.1/release-6.1.1']
---
...
- 针对不同操作系统和 CPU 架构的组合，引入不同级别质量标准的支持，见[操作系统及平台要求](https://docs-archive.pingcap.com/zh/tidb/v6.1/hardware-and-software-requirements#操作系统及平台要求)。
...
+ TiKV
    ...
    - 支持使用 [`server.simplify-metrics`](https://docs-archive.pingcap.com/zh/tidb/v6.1/tikv-configuration-file#simplify-metrics-从-v611-版本开始引入) 配置项过滤部分 Metrics 采样数据以减少每次请求返回的 Metrics 数据量 [#12355](https://github.com/tikv/tikv/issues/12355) @[glorv](https://github.com/glorv)

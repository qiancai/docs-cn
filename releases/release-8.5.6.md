...
aliases: ['zh/tidb/dev/release-8.5.6/', 'zh/tidb/v8.5/release-8.5.6']
---
...
| 系统表 | 变更类型 | 描述 |
| -------- | -------- | -------- |
| [`mysql.tidb`](https://docs.pingcap.com/zh/tidb/v8.5/mysql-schema#集群状态系统表) | 修改 | 新增 `cluster_id` 字段，用于记录 TiDB 集群的唯一标识，注意该值为只读，不可修改。 |
